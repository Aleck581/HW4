      ...
      .then((data) => {
        const formattedData = data.values.slice(1).map((item) => { // Skip the header row
          return {
            ...
            cover: `https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${encodeURIComponent(item[3])}&bgcolor=FFFFFF`, // QR code for the link
            artist: item[2], // You can modify this if you have artist data
            audio: item[3], // Audio link
